  ...
  return (
    <header>
      ...
      <section className="tn:h-20 flex items-start tn:items-center xl:max-w-8xl xl:mx-auto mx-1 tn:mx-5 flex-col tn:flex-row">
        <div className="flex mt-3 tn:mt-0">
          <Logo className="ml-2 w-24 h-8" />
          {isSmWindowSize && (
            <nav className="text-text-dark gap-x-4 lg:gap-x-9 font-medium items-center flex ml-9 md:ml-[5.5rem]">
              <>
                <NavLink
      ...
      {!isSmWindowSize && (
        <div className="fixed h-14 w-full drop-shadow-top shadow-top bottom-0 bg-primary">
